...
.PHONY: test-efs-ns-integration
test-efs-ns-integration:
	@echo "Running EFS Namespace Integration Tests"
	./scripts/run-efs-ns-integration-tests.sh

.PHONY: test-efs-ns-system
test-efs-ns-system:
	@echo "Running EFS Namespace System Integration Tests"
	./scripts/run-efs-ns-integration-tests.sh --suites system

.PHONY: test-efs-ns-performance
test-efs-ns-performance:
	@echo "Running EFS Namespace Performance Tests"
	./scripts/run-efs-ns-integration-tests.sh --suites performance

.PHONY: test-efs-ns-security
test-efs-ns-security:
	@echo "Running EFS Namespace Security Tests"
	./scripts/run-efs-ns-integration-tests.sh --suites security

.PHONY: test-efs-ns-reliability
test-efs-ns-reliability:
	@echo "Running EFS Namespace Reliability Tests"
	./scripts/run-efs-ns-integration-tests.sh --suites reliability

.PHONY: test-efs-ns-monitoring
test-efs-ns-monitoring:
	@echo "Running EFS Namespace Resource Monitoring Tests"
	./scripts/run-efs-ns-integration-tests.sh --suites monitoring

.PHONY: test-efs-ns-compliance
test-efs-ns-compliance:
	@echo "Running EFS Namespace CSI Compliance Tests"
	./scripts/run-efs-ns-integration-tests.sh --suites compliance

.PHONY: test-efs-ns-cleanup
test-efs-ns-cleanup:
	@echo "Cleaning up EFS Namespace test resources"
